...
public final class RecoveryStore
{
    ...
    static final String IS_SHOW_DEBUG_INFO = "recovery_is_show_debug";
    ...
    {
        public static final Creator<ExceptionData> CREATOR =
            new Creator<ExceptionData>()
            {
                @Override
        ...
        {
            return "ExceptionData{" + "className='" + className + '\''
