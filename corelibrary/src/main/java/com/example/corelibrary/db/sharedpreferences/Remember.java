package com.example.corelibrary.db.sharedpreferences;
 ...
 * 类名称: Remember.java
 * <p>
 * 类描述: 内存& 磁盘 保存工具 An in-memory data store backed by shared preferences. This
 * is a key-value store with a few important properties: <br>
 * <br>
