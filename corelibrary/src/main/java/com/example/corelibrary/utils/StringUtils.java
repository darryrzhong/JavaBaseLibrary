...
public class StringUtils
{
     ...
     */
    /*
     * public static String getString(@StringRes int id) { try { return
     * Utils.getApp().getResources().getString(id); } catch
     * (Resources.NotFoundException ignore) { return ""; } }
     */
     ...
     * try { return Utils.getApp().getString(id, formatArgs); } catch
     * (Resources.NotFoundException ignore) { return ""; } }
     */
     ...
     */
    /*
     * public static String[] getStringArray(@ArrayRes int id) { try { return
     * Utils.getApp().getResources().getStringArray(id); } catch
     * (Resources.NotFoundException ignore) { return new String[0]; } }
     */
}
